...
const PrivacyPolicyText = () => {
  ...
  return (
    <>
        ...
        <div className="mx-auto p-2 bg-gradient-to-r from-white via-purple-100 to-primary-200 max-w-prose w-full md:w-[850px] sm:w-4/5">
            ...
            <div className="blog-details">
                ...
                <p>
                    Your privacy is important to us and DNTrademark.com is committed to protecting the privacy of its users and the information that You share in connection with Our Service.Our Privacy Notice 
    ...
    interact with other users through the Site or Service.We may also collect Personal Data when You sign up for marketing emails,events,or other opportunities through DNTrademark.com.Personal Data may contain 
    Your name,email,contact information,as well as job titles,or other information You provide to DNTrademark.com.</p><p>&gt;Billing and transactional information pursuant to Your use of the Site 
    and 
    ...
    information,broad geographic location and other technical data collected through cookies,pixel tags or other similar technologies.</p><p>&gt;Information disclosed through the Site or Service 
    will be made available to other users of the Site or Service,who may send You unsolicited messages.Please do not post any information that You do not want to reveal to the public.</p><p 
   ><b>Examples of how We use Your Personal Data.</b></p><p>&gt;To provide You with Site and Service</p><p>To enhance the Site and Service</p><p>&gt;To 
    respond to Your requests or to manage user accounts</p><p>&gt;To provide feedback and understand Our users</p><p>&gt;To monitor the security of the Site or Service</p><p 
   >&gt;To provide You with promotional communications and materials</p><p><b>Information from third party sources and affiliated companies.</b></p><p>We may also 
    obtain 
    information about You through third party sources as permitted by applicable law,such as public databases,social media platforms,and reseller,channel,and joint marketing partners.</p><h2>II.Sharing Your 
   ...
   ><b>Business Partners.</b></p><p>We may share Your Personal Data with Our channel partners to fulfill obligations and requests,to deliver support,and to provide users and Our 
    ...
    time through Your DNTrademark.com profile.You can also opt-out of receiving marketing communications,deactivate,or delete Your account at any time.</p><h2>VI.Additional Rights for EEA users or similar 
    ...
    You.</p><p 
   >&gt;Right to object to processing:You may have the right to request that DNTrademark.com stop processing Your Personal Data and/or to stop sending You marketing communications.</p><p 
   ...
   >The DNTrademark.com Site and Service may link to other websites or services.Other websites may also contain links to the DNTrademark.com Site or Service.DNTrademark.com does not control those 
    websites 
    or their privacy practices.The personal information You choose to give to such parties is not covered by this Privacy Notice or the DNTrademark.com Privacy Policy.</p><p><b>Changes to this 
    Privacy Notice</b></p><p>DNTrademark.com will review and update this Privacy Notice in response to changing legal,technical and business developments.Please review this Privacy Notice 
    frequently 
   ...
   >We do not intentionally gather Personal Data from visitors who are under the age of 13.If a child under 13 submits Personal Data to DNTrademark.com and We learn that the Personal Data is the 
   ...
   ><b>(c)Information Collected From Address Book and Contact Importing</b></p><p>You may use Our address book and contacts importer to upload Your contacts from other services into 
    ...
    their 
    products and/or services through Our Services,and/or companies that otherwise collect such information.These third party companies may supply Us with Personal Data.We may add this information to the 
    information We have already collected from You via Services in order to improve Services We provide to You.</p><h2>VII Use Of Your Personal Data</h2><p><b>(a)General Use</b></p><p 
   >In general,Personal Data You submit to Us is used either to respond to requests that You make,or to aid Us in serving You better.We use Your Personal Data in the following ways:facilitate 
    the 
    creation of and completion of Your profile for use with the Site and Service;identify You as a User in Our system;provide improved administration of the Site and Service;provide the Site and 
    ...
    blogs and forums.</p><p><b>(c)Creation Of Anonymous Data</b></p><p>We may create Anonymous Data records from Personal Data by excluding information(such as Your name)that makes 
    the data personally identifiable to You.We use this Anonymous Data to analyze request and usage patterns so that We may enhance the content of Service and improve Site navigation.We reserve the right to 
    use Anonymous Data for any purpose and disclose Anonymous Data to third parties in Our sole discretion.</p><h2>VIII Disclosure Of Your Personal Data</h2><p>We disclose Your Personal Data as 
    described below and as described elsewhere in this Privacy Statement.</p><p><b>(a)Third Parties Designated By You</b></p><p>When You use the Service,the Personal Data You 
    provide 
    will be shared with the third parties that You designate to receive such information,including other websites,Your friends,relatives and business associates.Depending on the type of access You grant to 
    such third parties,they may also be permitted to edit the information You have provided to Us and to designate others to access and edit such information.You may change Your settings at any time as to 
    who 
   ...
   ><b>(f)Public Profile</b></p><p>Certain portions of the information You provide to us may also be displayed in Your Profile.As an essential element of the Service,most of the 
    Personal Data You explicitly provide to us when You register or update Your Profile is displayed on Your Profile.In order for Your Profile to be made public,You must go to Your profile settings and then 
    to 
    profile visibility.By default,Your Profile is not for public viewing.Your photos,posts,friends,and other content You post to the Site are also meant for public consumption.We may display this content on 
    ...
    engines).</p><p><b>(g)Other Disclosures</b></p><p>Regardless of any choices You make regarding Your Personal Data(as described below),DNTrademark.com may disclose Personal Data if 
    it 
    believes in good faith that such disclosure is necessary(a)in connection with any legal investigation;(b)to comply with relevant laws or to respond to subpoenas or warrants served on DNTrademark.com;(c)to 
    protect or defend the rights or property of DNTrademark.com or users of the Site or Service;and/or(d)to investigate or assist in preventing any violation or potential violation of the law,this Privacy 
    ...
    websites.We encourage You to read the privacy policies of every website You visit.The links to third party websites or locations are for Your convenience and do not signify Our recommendation of such 
    third 
   ...
   ><b>(a)Email Communications</b></p><p>We will periodically send You free newsletters and e-mails that directly promote the use of Our Site or Service.When You receive newsletters 
    ...
    the 
    interactivity between the Service and Your social media account or mobile device.</p><p><b>(d)Changing Or Deleting Your Personal Data</b></p><p>You may change any of Your 
    Personal 
    Data in Your Account by editing Your profile within Your Account.You may request deletion of Your Personal Data by us,and We will use commercially reasonable efforts to honor Your request,but please note 
    ...
    Security 
    Of Your Personal Data</h2><p>DNTrademark.com is committed to protecting the security of Your Personal Data.We use a variety of industry-standard security technologies and procedures to help 
    ...
    unauthorized 
    people.No method of transmission over the Internet,or method of electronic storage,is 100%secure,however.Therefore,while DNTrademark.com uses reasonable efforts to Your Personal Data,DNTrademark.com cannot 
