    ...
    <>
        ...
        <div className="mx-auto p-2 bg-gradient-to-r from-white via-purple-100 to-primary-200 max-w-prose w-full md:w-[850px] sm:w-4/5">
            ...
            <div className="blog-details">
                ...
                <p>DNtrademark.com and its contributors are not liable for incidental,special,punitive,consequential or exemplary 
                    damages of any kind,including,without limitation,loss of business,lost revenues or profits,or loss of data 
                    ...
                    warranty as to the results to be obtained from use of the site or its Content.In some states jurisdictions 
                    limitations of liability are not permitted.In such jurisdictions,some of the foregoing limitations may not 
                    apply to you.These limitations shall apply to the fullest extent permitted by law.
                </p>
                <h2 >Comments Sections and Content</h2>
                <p>By submitting Content to us or by posting comments or information on your profile,you are granting or warrant
                that the owner has express granted,to DNtrademark.com us a perpetual,irrevocable,royalty-free,and transferable right and 
                license to use and distribute and create derivative works.We may exercise this grant in any platform,media or technology
                for the full term of any copyright that may exist in such content.You are also hereby granting other affiliates of 
                DNtrademark.com the rights to use such content in a similar fashion.
                </p>
                <h2 >Content on other sites</h2>
                <p>DNtrademark.com has not reviewed and are not responsible for the content and actions of any of the sites that 
                    ...
                    from your use of non DNtrademark.com sites and pages.
                </p>
                <p>As a user of this Web Site you are granted a nonexclusive,nontransferable,revocable,limited license to access 
                    and use this Web Site and Content in accordance with these Terms of Use.Provider may terminate this license at
                    any time for any reason.
                </p>
                <p>The Content on is for your personal use only and not for commercial exploitation.You may not decompile,reverse 
                    ...
                    the United States of America.Any unauthorized use of this Web Site or its Content is prohibited.
                </p>
                <p>Nothing submitted to DNtrademark.com is treated as confidential.The accuracy,completeness,adequacy or currency of the 
                   Content is not warranted or guaranteed.Your use of Content on this Web Site or materials linked from this 
                   Web Site is at your own risk.
                </p>
                <p>DNtrademark.com may contain advertising and sponsorship.Advertisers and sponsors are responsible for ensuring that 
                    material submitted for inclusion on this Web Site is accurate and complies with applicable laws. 
                ...
                <p>The DNtrademark.com site AND THE CONTENT ARE PROVIDED ON AN&quot;AS IS&quot;and&quot;AS AVAILABLE&quot;BASIS.PROVIDER 
                    ...
                    FOR ANY LOSS,INJURY,CLAIM,LIABILITY,OR DAMAGE OF ANY KIND RESULTING FROM,ARISING
                     OUT OF OR ANY WAY RELATED TO(A)ANY ERRORS IN OR OMISSIONS FROM THIS WEB SITE AND THE 
                     CONTENT,INCLUDING,BUT NOT LIMITED TO,TECHNICAL INACCURACIES AND TYPOGRAPHICAL ERRORS,
                     (B)ANY THIRD PARTY CONTENT INCLUDING BUT NOT LIMITED TO ANY ERRORS IN OR OMISSIONS 
                     THEREFROM,(C)THE UNAVAILABILITY OF THIS WEB SITE OR ANY PORTION THEREOF,(D)YOUR 
                     USE OF THIS WEB SITE OR THE CONTENT,OR(E)YOUR USE OF ANY EQUIPMENT OR SOFTWARE 
                     IN CONNECTION WITH THIS WEB SITE.
                </p>
